...
class ConfigFileHandler:
    def __init__(self):
        ...
        self.backupPath = expanduser(
            "~") + "/.config/libinput-gestures.conf.bak"
    ...
    def openFile(self):
        self.validSupportedRegex = re.compile(
            "^\s*(#D:\s)?gesture\s((swipe)\s(up|down|left|right)|(pinch\s(in|out|clockwise|anticlockwise)))\s([2-4]\s)?(.+)")
        ...
        self.fileLines = ["# Generated by Gestures 0.1",
